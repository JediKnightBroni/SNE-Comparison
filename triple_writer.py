...
#file
#this script is name triple_writer because it writes 3 fields to the text file:
#steps, losses, and accuracy
import pickle
...
with open(outFileName, 'w') as fout:
    for line in L:
        fout.write('steps: ' + str(line[0]) + ', loss: ' + str(line[1]) + ', acc: ' + str(line[2]) + '\n')
